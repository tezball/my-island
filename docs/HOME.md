...
> [!info] Planning
> [`PRD-002`](ops/tickets/PRD-002.md) · [[ops/tickets/PRD-002]] curator seed plan [[ops/plans/PRD-002]] (`status: plan`). Next policy plan is still [`PRD-009`](ops/tickets/PRD-009.md) · [[ops/tickets/PRD-009]] (`ready`).
