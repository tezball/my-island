...
> [!todo] Doing / Review
> Epic [`WF-000`](../ops/tickets/WF-000.md) · [[ops/tickets/WF-000]] stays `implement` (automations still [`WF-003`](../ops/tickets/WF-003.md)). [`WF-016`](../ops/tickets/WF-016.md) · [[ops/tickets/WF-016]] is **In review** ([#48](https://github.com/tezball/my-island/pull/48)) — docs [#46](https://github.com/tezball/my-island/pull/46) and Eng grants+DSN landed; ticket stays `review`.
