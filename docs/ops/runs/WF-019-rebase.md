...
Hat: [[ops/agents/roles/eng-backend]]. Rebase PR #31 onto latest `main` after hotfix #33 restored live `ops/` / `product/` / `data/leads/`. Did not merge. Did not overwrite [[ops/tickets/WF-016]].
