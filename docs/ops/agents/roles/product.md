...
`product/VISION.md`, `product/MVP.md`, `product/EXPANSION.md`, inbound feature ideas, [[ops/runbooks/LISTING_ROLLOUT]].
...
`product/` (via Cursor PR if files change), `ops/company/`, starter epics [[ops/tickets/PRD-000]], [[ops/tickets/PRD-004]].
