...
When something is on fire, and once a week when it is not. Incidents: [[ops/templates/incident]]. Digest: [[ops/runbooks/WEEKLY_DIGEST]].

## Inputs

Grafana MCP (read-only), CI, [[ops/BOARD]], open PRs, inbound “the site is down”.
