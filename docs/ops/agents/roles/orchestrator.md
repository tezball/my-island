...
[[ops/BOARD]], [[ops/workflow/LOOP]], `python3 ops/scripts/next_ticket.py --role auto`, open PRs.
...
Terry: merge policy, automations UI ([[ops/tickets/WF-003]]), anything that needs prod. Do not escalate “board is stale” — run `board_sync.py`.
