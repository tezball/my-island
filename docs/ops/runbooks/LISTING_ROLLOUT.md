...
2. Coverage gaps: `PRD-*` for curator import, owned by [[ops/agents/roles/content-seo]]. Research collects unpublished leads in [`data/leads/`](../../data/leads/README.md) ([[ops/tickets/PRD-006]]).
