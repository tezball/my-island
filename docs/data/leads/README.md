...
Seed file: [`places.jsonl`](../../../data/leads/places.jsonl) (one JSON object per line). Schema: [`schema.json`](../../../data/leads/schema.json). Intended sources: [`SOURCES.md`](SOURCES.md). Legal: [`LEGAL.md`](LEGAL.md).
