...
- As an Owner, I want to add facilities and amenities to show what my campsite offers.
- As an Owner, I want to upload photos of my campsite and lots (multi-image, drag-drop, primary selection) to attract guests.
- As an Owner, I want to create a campsite through a guided onboarding wizard to save time.
- As an Owner, I want to view an analytics dashboard (occupancy, revenue, bookings, lot metrics) to understand my business performance.
...
- As a Guest, I want to save favorite lots so I can come back to them later.
