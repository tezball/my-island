...
The product is a **directory of places worth going to**, that you **tick off as you go**: points of
interest, experiences, campsites and B&Bs, plus — later — the businesses behind them.

So the name should carry *place, journey and the record of having been there*. It must not encode a
category. The previous name and its codebase were built around camping, and the moment a B&B needed
listing, the name was working against the product. Do not repeat that: **avoid any name that
describes what kind of place is listed.**
