...
Read [[ops/runbooks/STACK_E2E_PLACE_STUB]] and copy its commands. Do **not** invent curl.

Handoff: `docs/ops/workflow/STACK-E2E-place-stub.md`. Workshop: [[ops/tickets/E2E-001]]. Proven run: [[ops/runs/e2e-place-stub-mcp-chaos-2026-09-06]].
...
5. Write gaps in `docs/ops/runs/` or a `WF-*` ticket. Automation owns gap tickets.
...
- Expand into full [[ops/tickets/PRD-001]], product UI, or booking.
- Touch [[ops/tickets/WF-015]] (spine strip).
...
Cloud Agents often have **no** grafana MCP until a human adds dashboard stdio ([[ops/workflow/MCP]]) — use the runbook HTTP fallback.
