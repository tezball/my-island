...
export const OwnerSubscriptionBanner: React.FC = () => {
  const { subscription, redirectToCheckout, redirectToPortal, isLoading } = useOwnerSubscription();
  ...
  if (subscription.needsSubscription) {
    bannerType = 'warning';
    message = 'Activate your subscription to start listing your property.';
    ...
    const endDate = subscription.currentPeriodEnd
      ...
      : 'soon';
    message = `Your subscription will end on ${endDate}. Renew to keep your listings active.`;
    ...
    bannerType = 'error';
    message = 'Your subscription has ended. Resubscribe to continue listing your property.';
