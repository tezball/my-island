        ...
        <div className="max-w-3xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-primary hover:bg-emerald-600 text-white font-semibold text-sm rounded-lg transition-colors"
                >
                    ...
                    <div className="bg-white dark:bg-[#1a2632] rounded-xl max-w-lg w-full p-6" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="flex justify-end gap-3 mt-6">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-primary hover:bg-emerald-600 disabled:bg-gray-300 text-white font-semibold text-sm rounded-lg transition-colors"
                            >
                ...
                <div className="space-y-3">
                    {tickets.map(ticket => (
                        <button
                            ...
                            className="w-full text-left bg-white dark:bg-[#1a2632] rounded-xl border border-gray-200 dark:border-gray-800 p-4 hover:border-primary/50 dark:hover:border-primary/50 transition-colors"
                        >
