...
public class SupplierStaffController {
    ...
    public ResponseEntity<StaffMemberDto> addStaff(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(staffService.addStaffForSupplier(userDetails.getUserId(), request.email(), request.role()));
    }
    ...
    public ResponseEntity<StaffMemberDto> updateStaffRole(
        ...
        return ResponseEntity.ok(staffService.updateStaffRoleForSupplier(userDetails.getUserId(), id, request.role()));
    }
