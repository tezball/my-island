...
public class JdbcSupplierRepository {
    ...
    private MapSqlParameterSource toParameterSource(SupplierModel supplier) {
        ...
        params.addValue("phone", supplier.getPhoneNumber());
        params.addValue("email", supplier.getContactEmail());
        params.addValue("websiteUrl", supplier.getLogoUrl());
        params.addValue("address", supplier.getLocation());
        params.addValue("county", supplier.getEircode());
        params.addValue("lat", supplier.getLatitude());
        params.addValue("lng", supplier.getLongitude());
