...
| 2 | **Cleanup.** `docs/old/` is past-company history only. Do not implement from it. Tag `legacy-platform` is archaeology only. Canon = `product/` + `ops/`. Draft PRs #2 / #4 / #5 / #7 **closed** by Orchestrator (2026-09-05). | [`docs/old/README.md`](../../docs/old/README.md), [`docs/README.md`](../../docs/README.md), [[tickets/WF-008]] (done) |
