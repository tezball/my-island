...
**Company:** Halfdoor (public brand; subtitle “Halfdoor — places to stay & explore across Ireland.”). **Inis** is internal only. Repo stays `my-island`. Canon: `product/NAMING.md`.
...
Public brand is **Halfdoor**. **Inis** is internal only. Canon: `product/NAMING.md`. Vault naming: [[NAMING]].
