...
multibranchPipelineJob('my-island') {
  description('GitHub multibranch (PRs + main). Set GITHUB_USERNAME + JENKINS_GITHUB_TOKEN (username/password cred github-token). Laptop polls every 5m; no public webhook required.')
  branchSources {
    github {
      id('my-island-gh')
      repoOwner('tezball')
