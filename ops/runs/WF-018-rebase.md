...
Hat: [[agents/roles/automation-expert]]. Took over stuck PR #37 (`cursor/wf-018-e2e-fields-367e`). Rebased onto latest `origin/main` (`214431a`, after #36/#40/#41). Did not merge. Did not open a new PR.

## What happened

PR #37 was `CONFLICTING` / `DIRTY` after #36 then again after #41 landed on `main`. Replayed docs-only field align:

- Kept stub SoT: `categoryId`, `countyId`, `latitude`, `longitude` on [[tickets/E2E-001]] + canvas + vault tests
- [[workflow/STACK-E2E-place-stub]]: kept main’s sim + WF-017 drill lines; names now match [[tickets/E2E-001]]
