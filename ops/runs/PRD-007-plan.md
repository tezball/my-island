...
- [[plans/PRD-007]] — schema-only bar, pytest, idempotency, provenance
- Ticket notes: [[tickets/PRD-007]] → `plan`; [[tickets/PRD-008]] draft-Place AC + CreatePlaceRequest-style map; [[tickets/PRD-009]] Wave 1 does not waive counsel
...
success — human may merge the docs PR; set [[tickets/PRD-007]] `implement` before Research deposits.

## Follow-up

Eng plans import against [[tickets/PRD-008]]. Counsel remains [[tickets/PRD-009]].
